...
/**
 * Policy to check that request is done via authenticated user. This policy uses existing JWT tokens to validate that
 * user is authenticated. If use is not authenticate policy sends 401 response back to client.
 *
